				...
				{name : 'Tab1',
				 listts: [
					...
					{name: 'list1.2',					 
					 cards: [
						{name: 'card1.2.1',
						description: 'desc1.2.1'},
						{name: 'card1.2.2',
						description: 'desc1.2.2'},
						{name: 'card1.2.3',
						description: 'desc1.2.3'}
					 ]},
					{name: 'list1.3',				
					 cards: [
						{name: 'card1.3.1',
						description: 'desc1.3.1'},
						{name: 'card1.3.2',
						description: 'desc1.3.2'},
						{name: 'card1.3.3',
						description: 'desc1.3.3'}
					 ]}
				 ]},
				{name: 'Tab2',
				 listts: [
					{name: 'list2.1',
					 cards: [
						{name: 'card2.1.1',
						description: 'desc2.1.1'},
						{name: 'card2.1.2',
						description: 'desc2.1.2'},
						{name: 'card2.1.3',
						description: 'desc2.1.3'}
					 ]},
					{name: 'list2.2',					 
					 cards: [
						{name: 'card2.2.1',
						description: 'desc2.2.1'},
						{name: 'card2.2.2',
						description: 'desc2.2.2'},
						{name: 'card2.2.3',
						description: 'desc2.2.3'}
					 ]},
					{name: 'list2.3',				
					 cards: [
						{name: 'card2.3.1',
						description: 'desc2.3.1'},
						{name: 'card2.3.2',
						description: 'desc2.3.2'},
						{name: 'card2.3.3',
						description: 'desc2.3.3'}
					 ]}
				 ]},
				{name: 'Tab3',
				 listts: [
					{name: 'list3.1',
					 cards: [
						{name: 'card3.1.1',
						description: 'desc3.1.1'},
						{name: 'card3.1.2',
						description: 'desc3.1.3'},
						{name: 'card3.1.3',
						description: 'desc3.1.3'}
					 ]},
					{name: 'list3.2',					 
					 cards: [
						{name: 'card3.2.1',
						description: 'desc3.2.1'},
						{name: 'card3.2.2',
						description: 'desc3.2.2'},
						{name: 'card3.2.3',
						description: 'desc3.2.3'}
					 ]},
					{name: 'list3.3',				
					 cards: [
						{name: 'card3.3.1',
						description: 'desc3.3.1'},
						{name: 'card3.3.2',
						description: 'desc3.3.2'},
						{name: 'card3.3.3',
						description: 'desc3.3.3'}
					 ]}
				 ]}]
		}
	},
	...
	methods: {
		...
		createNewBoard() {
			...
			if(newTitle.length != 0 && srcBoardNr.length != 0) {
				axios.post('http://localhost:9000/api/boards/add', {
				  name: newTitle,
